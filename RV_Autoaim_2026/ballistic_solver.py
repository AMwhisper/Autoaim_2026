...
class BallisticSolver:
    ...
    def __init__(self):
        ...
        # 相机 → 枪口结构 (m)
        self.hero_cam_to_muzzle_z = 0.08
        self.hero_cam_to_muzzle_y = 0.13
        self.infantry_cam_to_muzzle_z = 0.08
        self.infantry_cam_to_muzzle_y = 0.13
        
        # 相机 → pitch (m)
        self.hero_cam_to_pitch = 0.13
        self.infantry_cam_to_pitch = 0.13
    def solve(self, yaw_cam_deg, pitch_cam_deg, distance_mm, robot="hero"):
        ...
        if robot == "hero":
            v = self.hero_speed
            cam_to_pitch_y = self.hero_cam_to_pitch
            cam_to_muzzle_z = self.hero_cam_to_muzzle_z
        else:
            v = self.infantry_speed
            cam_to_pitch_y = self.infantry_cam_to_pitch
